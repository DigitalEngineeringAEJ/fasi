...
#             'archive_groups': archive_groups,
    ...
    def print_protocol_report(self, protocol_id, **kw):
        ...
        if kw['type'] == 'maintenance':
            ...
            pdf = request.env.ref('wepelo_equipment.wepelo_equipment_eichnachweis_protocol').sudo()._render_qweb_pdf([protocol_id])[0]
            ...
            pdf = request.env.ref('wepelo_equipment.wepelo_equipment_bremsprufstand_protocol').sudo()._render_qweb_pdf([protocol_id])[0]
